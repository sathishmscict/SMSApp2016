...
public class FirstFragment extends EasyIntroFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txtLogin = (TextView)view.findViewById(R.id.txvLogin);
        btnRegister = (Button)view.findViewById(R.id.btnCreateAccount);
