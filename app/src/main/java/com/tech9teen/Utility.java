...
public class Utility {
    ...
    public static final int MY_PERMISSIONS_REQUEST_READ_SMS = 122;
    public static final int MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE = 124;
    public static final int REQUEST_CONTACTS = 121;
    public static final int MY_PERMISSIONS_REQUEST_READ_PHONE_NUMBERS = 120;

    public static final int MY_PERMISSIONS_REQUEST_WRTE_EXTERNAL_STORAGE = 111;
    ...
    public static boolean requestGetAcconuntsPermissionsRuntime(final Context context) {
        int currentAPIVersion = Build.VERSION.SDK_INT;
        if (currentAPIVersion >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(context,
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context, Manifest.permission.GET_ACCOUNTS)) {
                    ...
                    ActivityCompat.requestPermissions((Activity) context, new String[]{Manifest.permission.GET_ACCOUNTS}, 23); // my lucky number
                }
                return false;
            }
            return true;
    ...
    public static boolean requestGetContactsDataPermissionsRuntime(final Context context) {
        int currentAPIVersion = Build.VERSION.SDK_INT;
        if (currentAPIVersion >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(context,
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context, Manifest.permission.READ_CONTACTS)) {
                    ...
                    ActivityCompat.requestPermissions((Activity) context, new String[]{Manifest.permission.READ_CONTACTS}, 23); // my lucky number
                }
                return false;
            }
            return true;
