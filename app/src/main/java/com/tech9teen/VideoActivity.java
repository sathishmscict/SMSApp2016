...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GalleryAlbumAdapterRecyclerView(this, galleryVideoList);
...
//                    youTubeVersionText.setText(getString(R.string.youtube_not_installed));
        ...
        JsonArrayRequest req = new JsonArrayRequest(url_videos,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter = new GalleryAlbumAdapterRecyclerView(VideoActivity.this, galleryVideoList);
                        recyclerView.setAdapter(adapter);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            MenuItem common_show= (MenuItem)menu.findItem(R.id.common_show).setVisible(false);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return true;
