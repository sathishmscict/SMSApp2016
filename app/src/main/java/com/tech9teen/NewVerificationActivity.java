...
public class NewVerificationActivity extends AppCompatActivity {
    ...
    private TextView txtcode,txtmobile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtmobile = (TextView)findViewById(R.id.mob);
        txtcode = (TextView) findViewById(R.id.txtcode);
        btnsubmit = (Button) findViewById(R.id.btnsubmit);
        btnresend = (Button) findViewById(R.id.btnresend);
        txterror = (TextView) findViewById(R.id.txterror);
        Mobile = userDetails.get(SessionManager.KEY_USER_MOBILE);
        txtmobile.setText(Mobile);

        countdowntimer = new MyCountDownTimer(TIMER_SECONDS, 1000);
