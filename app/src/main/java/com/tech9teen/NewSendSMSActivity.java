...
public class NewSendSMSActivity extends AppCompatActivity {
    ...
    private NewSendSMSActivity.ContactsAdapterRecyclerView contacts_adapter;
    ...
    private CardView crdMultiple;
    private CardView crdMessageRoute;
    private ImageView imgAddGroup;
    private Button btnScheduleSMS;
    public static final int PICK_CONTACT = 121;
    private LinearLayout llbtnScheduleSMS;
    private boolean ISSCHEDULE = false;
    private String SCHEDULETIME;
    private TextView txtSmsCounter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tech9teen.R.layout.activity_new_send_sms);
        ...
        txtSmsCounter = (TextView)findViewById(R.id.txtSmsCounter);


        txtSmsCounter.setText("0 / 1  Message");
        ...
        txtMessage.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(s.length() !=0 )
                {
                    int mes = (s.length()/160)+1;
                    if(mes == 1)
                    {
                        txtSmsCounter.setText(s.length()+"/"+mes+" Message");
                    }
                    else
                    {
                        txtSmsCounter.setText(s.length()+"/"+mes+" Messages");
                    }
                ...
                {
                    txtSmsCounter.setText(s.length()+"/ 1  Message");
                }
        ...
        btnScheduleSMS = (Button) findViewById(R.id.btnScheduleSMS);

        llbtnScheduleSMS = (LinearLayout) findViewById(R.id.llbtnScheduleSMS);
        ...
        btnScheduleSMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                chkScheduleSMS.setChecked(true);

                //btnScheduleSMS.setVisibility(View.GONE);
                llbtnScheduleSMS.setVisibility(View.GONE);
        ...
        crdMultiple = (CardView) findViewById(R.id.crdMultiple);

        crdMessageRoute = (CardView) findViewById(R.id.crdMessageRoute);


        llRequestSenderId.setOnClickListener(
                ...
                if (errorFlag == false) {
                    ...
                    if (ROUTE.toLowerCase().equals("route1")) {
                        ...
                        if (ContextCompat.checkSelfPermission(context, android.Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            ActivityCompat.requestPermissions(NewSendSMSActivity.this, new String[]{android.Manifest.permission.SEND_SMS},
                        ...
                        if (NetConnectivity.isOnline(context)) {
                            ...
                            StringRequest str_sendsms = new StringRequest(Request.Method.POST, url_sendsms, new Response.Listener<String>() {
                                ...
                                protected Map<String, String> getParams() throws AuthFailureError {
                                    ...
                                    /*
                                    Older Code Senderid based on selection
                                    ...
                                    /**
                                     * get Deafult route from settings
                                     */

                                    if (userDetails.get(SessionManager.KEY_DEFAULT_ROUTETYPE).toLowerCase().equals("route2")) {
                                        params.put("senderid", list_senderid_route2.get(spnSenderId.getSelectedItemPosition()));

                                    } else if (userDetails.get(SessionManager.KEY_DEFAULT_ROUTETYPE).toLowerCase().equals("route3")) {
                                        params.put("senderid", list_senderid_route3.get(spnSenderId.getSelectedItemPosition()));
                                    }

                                    params.put("senderid",userDetails.get(SessionManager.KEY_DEFAULT_SENDERID));
                                    ...
                                    //Older code for route type
                                    //params.put("routetype", ROUTE);

                                    //New Code for selectig default route
                                    params.put("routetype", userDetails.get(SessionManager.KEY_DEFAULT_ROUTETYPE));


                                    params.put("date", "" + dbhandler.convertToJsonDateFormat(txtDate.getText().toString()));

                                    params.put("time", SCHEDULETIME);

                                    //params.put("time", "" + txtTime.getText().toString());


                                    Log.d(TAG, "Send SMS ; " + url_sendsms + params.toString());
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                Toast.makeText(NewSendSMSActivity.this, "Please install a File Manager.",
 ...
 */
                ...
                if (userDetails.get(SessionManager.KEY_MESSAGETYE).toLowerCase().equals("single")) {
...
*/
        ...
        RadioButton rdTrans = (RadioButton) findViewById(R.id.rdRoute3);
        ...
        if (userDetails.get(SessionManager.KEY_MESSAGETYE).equals("single")) {

            crdMessageRoute.setVisibility(View.GONE);
        ...
        } else if (userDetails.get(SessionManager.KEY_MESSAGETYE).equals("contacts")) {
            crdMessageRoute.setVisibility(View.GONE);
            crdMessageTyepSingleMultiple.setVisibility(View.GONE);
            //MESSAGETYPE = "multiple";
            MESSAGETYPE = "single";
        ...
        } else if (userDetails.get(SessionManager.KEY_MESSAGETYE).equals("group")) {
            crdMessageRoute.setVisibility(View.GONE);
            crdMessageTyepSingleMultiple.setVisibility(View.GONE);
            MESSAGETYPE = "multiple";

            RadioButton rb = (RadioButton) findViewById(R.id.rdMultiple);
            rb.setChecked(true);

            btnImportCSV.setVisibility(View.GONE);

            RadioButton rbMul = (RadioButton) findViewById(R.id.rdMultiple);
            rbMul.setChecked(true);
    ...
    private void ClearDetails() {
        ...
        RadioButton r1 = (RadioButton) findViewById(R.id.rdRoute3);
        r1.setChecked(true);
        ...
        //btnScheduleSMS.setVisibility(View.VISIBLE);
        llbtnScheduleSMS.setVisibility(View.VISIBLE);
    ...
    public void checkInternet() {
        Snackbar snackbar = Snackbar
                ...
                .setAction("RETRY", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (NetConnectivity.isOnline(context)) {
                            Intent intent = new Intent(context, NewSendSMSActivity.class);
                            startActivity(intent);
                            finish();
                            overridePendingTransition(R.anim.slide_left, R.anim.slide_right);
...
//Complete Date Dialog Picer
    ...
    private void updateTime(int hours, int mins) {
        ...
        SCHEDULETIME = SCHEDULETIME + minutes;
                    ...
                    if (resultCode == Activity.RESULT_OK) {
                        ...
                        if (c.moveToFirst()) {
                            ...
                            if (hasPhone.equalsIgnoreCase("1")) {
                                ...
                                //MOBILENO = cNumber;
                                Toast.makeText(context, "Length  : " + cNumber.length(), 1000).show();

                                cNumber = cNumber.replaceAll("\\D+", "");
                                if (cNumber.length() >= 10) {


                                    txtMobile.setText(cNumber);

                                } else {
                                    Toast.makeText(getApplicationContext(), "Invalid mobile no", Toast.LENGTH_SHORT).show();
                                    Snackbar.make(coordinateLayout, "Inbalid Mobile No ", Snackbar.LENGTH_SHORT).show();
                                }
...
*/
     ...
     */
    public class ContactsAdapterRecyclerView extends RecyclerView.Adapter<NewSendSMSActivity.ContactsAdapterRecyclerView.MyViewHolder> {
        ...
        @Override
        public NewSendSMSActivity.ContactsAdapterRecyclerView.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

            View view = inflater.inflate(R.layout.row_single_contact_cardview, parent, false);
            NewSendSMSActivity.ContactsAdapterRecyclerView.MyViewHolder viewHolder = new NewSendSMSActivity.ContactsAdapterRecyclerView.MyViewHolder(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(NewSendSMSActivity.ContactsAdapterRecyclerView.MyViewHolder holder, int position) {
    ...
    private void GetAllContactsFromDevice() {
        ...
        contacts_adapter = new NewSendSMSActivity.ContactsAdapterRecyclerView(context, listContacts);
    ...
    /**
     * Hanlder For Pic Contact From Device
     */
