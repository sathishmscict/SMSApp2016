...
public class LeftToggleIndicator extends AbstractToggleIndicator {
    private OnToggleIndicatorsClickListener mListener;

    public LeftToggleIndicator(Context context) {
        super(context);
    }

    public LeftToggleIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LeftToggleIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void makeItSkip() {
        setImageResource(R.drawable.ic_clear_white_24dp);
    }

    public void makeItPrevious() {
